...
public class RealAct2 : MonoBehaviour
{
    public static RealAct2 Instance;

    // Character Images
    public Image minister, secretary, parents, informer, policeCommissioner, unknownCaller;
    ...
    private void UpdateSliders(int corruptionChange, int moraleChange, int politicalChange)
{
    ...
    private void ResetCharacterVisibility()
    {
        ...
        policeCommissioner.enabled = false;
        unknownCaller.enabled = false;
    }
    ...
    private void ShowCharacter(string character)
    {
        ...
        switch (character.ToLower())
        {
            ...
            case "parents": parents.enabled = true; break;
            case "informer": informer.enabled = true; break;
            case "policecommissioner": policeCommissioner.enabled = true; break;
            case "unknowncaller": unknownCaller.enabled = true; break;
